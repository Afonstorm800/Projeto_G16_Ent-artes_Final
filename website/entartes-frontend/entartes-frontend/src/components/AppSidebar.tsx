...
const navItems: { id: string; label: string; icon: typeof LayoutDashboard; roles: UserRole[] }[] = [
  { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["direcao", "professor", "encarregado"] },
  ...
  { id: "inventory", label: "Inventário", icon: Package, roles: ["direcao", "encarregado"] },
