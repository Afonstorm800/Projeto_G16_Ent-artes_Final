            ...
            <div className="p-6 space-y-6">
              ...
              {submitted ? (
                ...
                <>
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm font-medium text-foreground block mb-2">Educando</label>
                      <select
                        value={educando}
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Cada educando interessado faz o seu próprio pedido.</p>
                    </div>
